...
import './bottomColorRiseTestimonials.css';

export default class BottomColorRiseTestimonials extends Component {
    state = {
    };

    render(){
        return (
            <div className={"bottom-color-rise-testimonials " + this.props.settings.theme}>
