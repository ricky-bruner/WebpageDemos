            ...
            <div className="homepage">
                ...
                <div className="homepage-body">
                    <div className="homepage-info">
                        ...
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;Transfigure.io is the evolution of my attmepts to follow along with the masterful work being done by Muhammad Irshad with his Online Tutorials youtube channel. Ive always had a healthy appreciation for visual flair on webpages, and have missed it dearly since my time at NSS. What started as many small side projects has turned into one here, and eventually I wondered... what would be the best way to make these demos accessible to those that may be interested? I decided to build a page in the likeness of other style libraries that I am familiar with - Bootstrap and Semantic mostly - and sincerely hope that current students find their way here.</p> 
                        <p>&nbsp;&nbsp;&nbsp;&nbsp;How would you use it? I'd love for you to follow my example. Copy this code - play with it - break it - improve it! If you just need something neat for a personal website - please take and make it yours! Below is a comprehensive diagram of how to best utilize Transifgure.io</p>
