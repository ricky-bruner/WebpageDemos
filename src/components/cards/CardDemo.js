...
import CardDemoFactory from '../../modules/cards/CardDemoFactory';
    ...
    render(){
        return (
            <div className="demo-section">
                <h2 className="card-demo-title">{this.props.title}</h2>
                ...
                {/* <div>
                    <h5>All Colors: {this.state.showAllColors.toString()}</h5>
                    <h5>Color: {this.state.color}</h5>
                    <h5>Prop Color: {this.props.options.color}</h5>
                    <h5>All Sizes: {this.state.showAllSizes.toString()}</h5>
                    <h5>Size: {this.state.size}</h5>
                    <h5>Prop Size: {this.props.options.size}</h5>
                    <h5>All Speeds: {this.state.showAllSpeeds.toString()}</h5>
                    <h5>Speed: {this.state.speed}</h5>
                    <h5>Prop Speed: {this.props.options.speed}</h5>
                    <h5>All Borders: {this.state.showAllBorders.toString()}</h5>
                    <h5>Border: {this.state.border}</h5>
                    <h5>Prop Border: {this.props.options.border}</h5>
                </div> */}
                <div className="demo-container">
                    {CardDemoFactory(this.props.demoName, this.getSettings())}
                </div>
