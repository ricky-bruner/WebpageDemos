...
export default class AnimatedOutlineButtonDemo extends Component {
    state = {
        html: ".animated-outline-button-demo",
        theme: "dark",
        size: "",
        color: "blue",
    ...
    render(){
        return (
            <div className="demo-section">
                <div className="animated-outline-button-demo">
                    <h2>Animated Outline Buttons</h2>
                    ...
                    <div className={"demo-container " + this.state.theme}>
                            ...
                            this.state.sizes.map(s => {
                                return (
                                    <div className="button-container" data-text={s}>
                                        <button className={"animated-outline-button " + s + " " + this.state.color + " " + this.state.theme}>
                                            <svg>
                                                <rect></rect>
                                            </svg>
                                            Button
                        ...
                        }
                        {
                            ...
                            <div className="button-container" data-text={this.state.size}>
                                <button className={"animated-outline-button " + this.state.size + " " + this.state.color + " " + this.state.theme}>
                                    <svg>
                                        <rect></rect>
                                    </svg>
                                    Button
                            ...
                            <div className="button-container" data-text="Colors">
                                {
                                    this.state.colors.map(c => {
                                        return (
                                            <button className={"animated-outline-button " + this.state.size + " " + c + " " + this.state.theme}>
                                                <svg>
                                                    <rect></rect>
                                                </svg>
                                                Button
