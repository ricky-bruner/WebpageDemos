...
export default class RovingBorderNavbarDemo extends Component {
    state = {
        html: ".roving-border-navbar-demo",
        theme: "dark",
        themes: [ "light", "dark" ],
        color: "black",
    ...
    render(){
        return (
            <div className="demo-section">
                <div id="home" className="roving-border-navbar-demo">
                    <h2>Roving Border Navbar Demo</h2>
                        ...
                        <div className="navbar-container" data-text="Navbar">
                            {
                                ...
                                <ul className={"roving-border-navbar " + this.state.theme + " " + this.state.color + " " + this.state.border}>
                            ...
                            }
                            {
                                ...
                                this.state.colors.map(c => {
                                    return (
                                        <ul className={"roving-border-navbar " + this.state.theme + " " + c + " " + this.state.border}>
                                            <li><a href="home">Home</a></li>
                                            <li><a href="home">About</a></li>
                                            <li><a href="home">Services</a></li>
                                            <li><a href="home">Portfolio</a></li>
