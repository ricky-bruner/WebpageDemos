...
export default class CornerBracketHoverNavbarDemo extends Component {
    state = {
    ...
    render(){
        return (
            <div className="demo-section">
                <div id="home" className="corner-bracket-hover-navbar-demo">
                        ...
                        <div className="navbar-container" data-text="Navbar">
                            {
                                ...
                                <ul className={"corner-bracket-hover-navbar " + this.state.theme + " " + this.state.color + " " + this.state.border}>
                            ...
                            }
                            {
                                ...
                                this.state.colors.map(c => {
                                    return (
                                        <ul className={"corner-bracket-hover-navbar " + this.state.theme + " " + c + " " + this.state.border}>
                                            <li><a href="home">Home</a></li>
                                            <li><a href="home">About</a></li>
                                            <li><a href="home">Services</a></li>
                                            <li><a href="home">Portfolio</a></li>
