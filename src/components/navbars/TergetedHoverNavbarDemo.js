...
export default class TargetedHoverNavbarDemo extends Component {
    state = {
        html: ".targeted-hover-navbar-demo",
        theme: "light",
        themes: [ "light", "dark" ],
        color: "hotpink",
    ...
    toggleAllColors = () => {
        let color = !this.state.showAllColors ? "" : "hotpink";
    ...
    render(){
        return (
            <div className="demo-section">
                <div id="home" className="targeted-hover-navbar-demo">
                    <h2>Targeted Hover Navbar Demo</h2>
                        ...
                        <div className="navbar-container" data-text="Navbar">
                            {
                                ...
                                <ul className={"targeted-hover-navbar " + this.state.theme + " " + this.state.color + " " + this.state.border}>
                            ...
                            }
                            {
                                ...
                                this.state.colors.map(c => {
                                    return (
                                        <ul className={"targeted-hover-navbar " + this.state.theme + " " + c + " " + this.state.border}>
                                            <li><a href="home">Home</a></li>
                                            <li><a href="home">About</a></li>
                                            <li><a href="home">Services</a></li>
                                            <li><a href="home">Portfolio</a></li>
